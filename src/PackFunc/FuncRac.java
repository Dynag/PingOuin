...
public class FuncRac {
    public void creerRacBureau() throws IOException, InterruptedException{
        ...
        String commande1 =  "@echo off &&" +
                            ...
                            "echo oLink.TargetPath = \""+Var.path+"\\PingOuin.jar\" >> CreateShortcut.vbs &&" +
                            "echo oLink.WorkingDirectory  = \""+Var.path+"\" >> CreateShortcut.vbs &&" +
                            "echo oLink.IconLocation = \""+Var.path+"\\ico.ico >> CreateShortcut.vbs &&"+
